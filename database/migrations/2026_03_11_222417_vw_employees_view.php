...
// database/migrations/2025_01_01_000021_create_vw_employees_view.php
    ...
    public function up()
    {
        DB::statement("
            ...
            SELECT
                ...
                ed.signature_image,
                ea.position_uuid,
                ea.start_date AS position_start,
                ea.end_date AS position_end,
                ea.active AS position_active,
